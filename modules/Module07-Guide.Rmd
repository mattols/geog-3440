...
1. Introduction to common packages in R
2. Efficient workflows with piping and dplyr  
3. Visualization with ggplot
4. Pivot tables and advanced joins
...
# install.packages("dplyr") # only need to install once!
library(dplyr)
```
...
Data manipulation is a key part of data science. Your workflows will improve as you discover new libraries and functions throughout the semester.

There are tens of thousands of R packages developed by the community and many new, useful packages are developed each year! The R community is vast and an excellent place to learn and grow your geospatial data science skills.
...
**Complete the Module Task** by updating the provided *Template*
The task submission this week is different than previous weeks
